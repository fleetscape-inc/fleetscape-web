...
export const metadata: Metadata = {
  ...
  description:
    "Premium pneumatic ground cover installation for commercial properties, municipalities, and HOAs across California's Central Coast. Mulch, playground chips, and landscaper partnerships.",
};
...
const services = [
  ...
  },
  {
    ...
    description: "Certified engineered wood fiber for safe, compliant play areas",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
const differentiators = [
  {
    ...
    description:
      "Our Commercial Blower Truck delivers 60 cubic yards per trip and places material up to 600 feet — with remote-controlled variable rates for even, precise coverage. No wheelbarrows. No raking. No mess.",
  },
  {
    title: "Speed & Scale",
    description:
  ...
  },
  {
    ...
    description:
      "Licensed (CSLB C-27), fully insured, and USDOT registered. We meet the compliance standards your organization requires — so there's no red tape on your end.",
  },
];

const cities = ["Santa Barbara", "Montecito", "Ventura", "Oxnard", "Camarillo"];
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="max-w-3xl mb-16 fade-in">
            ...
            <p className="text-lg text-charcoal/80 leading-relaxed">
              We use pneumatic blower truck technology to apply over 200 cubic
              yards of ground cover materials per day, with speed and precision
              that manual methods can&apos;t match. One truck replaces a full
              crew — delivering materials up to 600 feet from the truck
              directly to the installation point. Projects that take days by
              hand are completed in hours.
            </p>
          </div>
